"""CLI for exporting deterministic analysis snapshots."""
...
from insights.snapshot_store import save_snapshot
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Export a versioned analysis snapshot artifact."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    snapshot_path = save_snapshot(snapshot=snapshot, snapshot_dir=snapshot_dir)
    print(
        json.dumps(
            {
