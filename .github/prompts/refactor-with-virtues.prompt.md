...
4. Apply stewardship virtues (Aligned, Discovered, Traceable, Conservative).
5. Apply naming rules:
   - audience/team vocabulary
   - domain terms over generic terms
   - purpose-oriented names
   - context over redundancy
   - scope-appropriate length
6. Keep or improve test coverage as needed.
